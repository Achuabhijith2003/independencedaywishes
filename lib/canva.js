...
const ogImg = `https://images.weserv.nl/?url=https://img.sanweb.info/india/india/?name=${pageCatch}`;
...
LoadmyFont.load().then(function (font) {
    ...
    imageObj.src = './WhatsApp Image 2024-08-14 at 19.38.12_8182cf70.jpg';
});
